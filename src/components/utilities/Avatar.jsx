...
const Avatar = ({ src = "../../../public/avatar-man.png" }) => {
  // src = "../../../public/avatar-man.png";
  return (
    <>
      <div className="w-24 h-24 flex justify-center m-auto items-center overflow-hidden text-white rounded-full bg-stone-300">
